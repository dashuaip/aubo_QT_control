...
//        }
        ...
        robotService.robotServiceSetGlobalMoveEndMaxLineVelc(endMoveMaxVelc);
        robotService.robotServiceSetGlobalMoveEndMaxAngleVelc(endMoveMaxVelc);
        Util::initJointAngleArray(jointAngle, Util::RAD, -0.000003, -0.127267, -1.321122, 0.376934, -1.570796, -0.000008);
        robotService.robotServiceAddGlobalWayPoint(jointAngle);
        Util::initJointAngleArray(jointAngle, Util::RAD, 0.100000, -0.147267, -1.321122, 0.376934, -1.570794, -0.000008);
        robotService.robotServiceAddGlobalWayPoint(jointAngle);
        Util::initJointAngleArray(jointAngle, Util::RAD, 0.200000, -0.167267, -1.321122, 0.376934, -1.570796, -0.000008);
        robotService.robotServiceAddGlobalWayPoint(jointAngle);
...
void Example_5::demo1()
{
    ...
    //Preparation point
    double jointAngle[aubo_robot_namespace::ARM_DOF];
    Util::initJointAngleArray(jointAngle, Util::DEG,  0.0, 0.0, 90.0, 0.0, 90.0, 0.0);
    ret = robotService.robotServiceJointMove(jointAngle, true);   //Joint movement to preparation point
    if(ret != aubo_robot_namespace::InterfaceCallSuccCode)
    {
